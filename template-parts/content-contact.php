...
<section class="contact-form py-5">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8">
				<div class="p-4">
					<h3 class="pb-3 font-weight-bold">Drop Us A line</h3>
					<form class="contact-form">
					  ...
					  <div class="form-group">
					    <!-- <label for="exampleInputPassword1">Password</label> -->
					    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Details">
					  </div>
